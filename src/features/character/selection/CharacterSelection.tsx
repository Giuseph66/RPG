...
export function CharacterSelection({ characters = [], drafts = [], status = "idle", error, onSelect, onCreate, onResumeDraft, onRetry }: CharacterSelectionProps) {
